<nav x-data="{ open: false }" class="glass sticky inset-x-0 top-0 z-50">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img class="mx-auto h-8 w-auto" src="{{ asset('gaelanlogo.png') }}" alt="Your Company">
                    </a>
                </div>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                            ...
                            <div class="relative w-7 h-7 overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600 ms-2">
                            ...
                            {{-- <img class="w-6 h-6 rounded-full" src="{{ Auth::user()->logo }}" alt="user photo"> --}}
                        </button>
                    </x-slot>
